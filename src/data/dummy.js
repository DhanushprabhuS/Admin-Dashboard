...
export const EditorData = () => (
  <div>
    <h2>
    <b>Kalki’s Ponniyin Selvan : The Ponni’s Son – World-famous Epic Tamil Historic Novel</b>
    </h2>
    <h3>
      The title Ponniyin Selvan literally translates to “Son of Kaveri / Cauvery” – Ponni is another name for the Cauvery river, and it is one of the best historical novels ever written in the Tamil language as it isn’t just an imaginative tale, but rather a historically accurate tale with little creativity. 
      For his research, Kalki traveled to many places for researching his Ponniyin Selvan project.
...
export const chatData = [
  {
    image:
      avatar2,
    message: 'Kanish Joined the Team!',
  ...
  },
  {
    ...
    desc: 'Sara sent you new message',
    time: '11:56 AM',
  },
  {
    image:
  ...
  },
  {
    image:
      avatar,
    message: 'Nandhini completed tasks',
