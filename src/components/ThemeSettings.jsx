    ...
    className='bg-half-transparent w-screen fixed nav-item top-0 right-0'>
      <div className='float-right h-screen dark:text-gray-200 bg-white dark:bg-main-dark-bg w-400'>
        ...
        <div className='flex-col border-t-1 border-color p-4 ml-4'>
              ...
              <TooltipComponent key={index} content={item.name} position='TopCenter'>
                <div className='relative mt-2 cursor-pointer  flex gap-5 items-center'>
                  ...
                  >
                    ...
                    ${item.color === currentColor?'bolck':'hidden'}`}/>
                  </button>
                </div>
              </TooltipComponent>
            ))}
          ...
          <div className='flex gap-3 mt-96 justify-center'>
            <p>Developed by <a href='https://github.com/DhanushPrabhuS'><b>DhanushPrabhuS</b></a></p>
          </div>
